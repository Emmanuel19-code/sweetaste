...
const Sidebar = () => {
  return (
    <div className="bg-white w-60 flex flex-col h-screen">
      <div className=" p-2">
      ...
      <div className="flex flex-col mt-8 justify-between h-screen">
        <div className="flex-1  p-2 flex flex-col">
          <NavLink to={"/dashboard"} className={({isActive})=>isActive&&'bg-yellow-500 rounded-xl text-green-800 font-bold'}>
        ...
        <div className="p-2 ml-2">
            ...
            <div className="flex flex-row">
                <img src="images/man.jpg" alt="" className="w-10 h-10 rounded-full"/>
                <div>
